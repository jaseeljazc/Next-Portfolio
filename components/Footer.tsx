      ...
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-bold bg-linear-to-r from-violet-500 to-violet-700 bg-clip-text text-transparent mb-2">
              Portfolio
            </h3>
            <h2  className="text-gray-200">Muhammed Jaseel</h2>
